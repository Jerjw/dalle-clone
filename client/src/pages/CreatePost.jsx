...
const CreatePost = () => {
    ...
    const generateImage = async () => {
        if(form.prompt) {
            try {
                ...
                const response = await fetch('https://dall-e-fq9z.onrender.com/api/v1/dalle', {
                    method: 'POST',
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if(form.prompt && form.photo) {
            ...
            try {
                const response = await fetch('https://dall-e-fq9z.onrender.com/api/v1/post', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    return (
        <section className='max-w-7xl mx-auto'>
            <div>
                ...
                <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Crreate imaginative and visually stunning images through DALL-E AI and share them with the community</p>
            </div>
            ...
            <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
                <div className='flex flex-col gap-5'>
                    ...
                    placeholder="A photograph of a cyborg exploring Tokyo at night, lomography" value={form.prompt} handleChange={handleChange} isSurpriseMe handleSurpriseMe={handleSurpriseMe}/>
